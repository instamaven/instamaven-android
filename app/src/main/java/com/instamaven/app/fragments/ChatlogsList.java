...
public class ChatlogsList extends ListFragment {

    ChatLogsProvider clp;
    ListView listView;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        clp = new ChatLogsProvider(getActivity(), listView);

        if ((chatlogs = clp.getData()) != null) {
            adapter = new ChatLogsListAdapter(getActivity(), chatlogs);
