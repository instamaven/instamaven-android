...
import com.instamaven.app.models.ActivityEntity;
...
public class ActivitiesOutcomeProvider extends EntitiesProvider implements EntitiesProvider.ListProvider {

    private Context context;
    private ListAdapter adapter;
    private View spinnerView;

    public ActivitiesOutcomeProvider(Context ctx, ListView view) {
        super(view);
        this.context = ctx;
    ...
    public ArrayList<Entity> getData(Integer page) {
        ...
        try {
            String response = client
                    .setUrl(SettingsHelper.getUrl(context, "get_activities_outcome"))
                    .setMethod("GET")
            ...
            if (obj.opt("error") != null) {
                ...
                list = getEntityList(ActivityEntity.class, items, page);
