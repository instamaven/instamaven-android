...
public class ActivitiesIncomeProvider extends EntitiesProvider implements EntitiesProvider.ListProvider {

    private Context context;
    private ListAdapter adapter;
    private View spinnerView;

    public ActivitiesIncomeProvider(Context ctx, ListView view) {
        super(view);
        this.context = ctx;
    ...
    public ArrayList<Entity> getData(Integer page) {
        ...
        try {
            String response = client
                    .setUrl(SettingsHelper.getUrl(context, "get_activities_income"))
                    .setMethod("GET")
