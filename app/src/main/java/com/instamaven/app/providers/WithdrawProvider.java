...
import com.instamaven.app.models.WithdrawEntity;
...
public class WithdrawProvider extends EntitiesProvider implements EntitiesProvider.ListProvider {

    private Context context;
    private ListAdapter adapter;
    private View spinnerView;

    public WithdrawProvider(Context ctx, ListView view) {
        super(view);
        this.context = ctx;
    ...
    public ArrayList<Entity> getData(Integer page) {
        ...
        try {
            String response = client
                    .setUrl(SettingsHelper.getUrl(context, "get_withrawings"))
                    .setMethod("GET")
                    .send();
            ...
            if (obj.opt("error") != null) {
                ...
                list = getEntityList(WithdrawEntity.class, items, page);
            }
        } catch (Exception e) {
