...
import com.instamaven.app.models.AvatarThemeEntity;
...
public class AvatarsThemesProvider extends EntitiesProvider implements EntitiesProvider.ListProvider{

    private Context context;
    private ListAdapter adapter;
    private View spinnerView;

    public AvatarsThemesProvider(Context ctx, ListView view) {
        super(view);
        this.context = ctx;
    ...
    public ArrayList<Entity> getData(Integer page) {
        ...
        try {
            String response = client
                    .setUrl(SettingsHelper.getUrl(context, "get_avatars_categories"))
                    .setMethod("GET")
                    .send();
            ...
            if (obj.opt("error") != null) {
                ...
                list = getEntityList(AvatarThemeEntity.class, items, page);
            }
        } catch (Exception e) {
