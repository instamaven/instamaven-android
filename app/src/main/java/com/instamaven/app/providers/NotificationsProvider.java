...
import com.instamaven.app.models.NotificationEntity;
...
public class NotificationsProvider extends EntitiesProvider implements EntitiesProvider.ListProvider {

    private Context context;
    private ListAdapter adapter;
    private View spinnerView;

    public NotificationsProvider(Context ctx, ListView view) {
        super(view);
        this.context = ctx;
//        spinnerView = inflater.inflate(R.layout.progress_spinner, null);
    ...
    public ArrayList<Entity> getData(Integer page) {
        ...
        try {
            String response = client
                    .setUrl(SettingsHelper.getUrl(context, "get_notifications"))
                    .setMethod("GET")
            ...
            if (obj.opt("error") != null) {
                ...
                list = getEntityList(NotificationEntity.class, items, page);
    ...
    public void clearAll() throws Exception {
        JSONObject obj;
        String response = client
                .setUrl(SettingsHelper.getUrl(context, "patch_clear_notifications"))
                .setMethod("PATCH")
                .send();
        obj = new JSONObject(response);
        if (obj.opt("error") != null) {
    ...
    public void deleteOne() throws Exception {
        JSONObject obj;
        String response = client
                .setUrl(SettingsHelper.getUrl(context, "delete_notifications"))
                .setMethod("DELETE")
                .send();
        obj = new JSONObject(response);
        if (obj.opt("error") != null) {
