...
public class PackageProvider extends EntitiesProvider implements EntitiesProvider.ListProvider{

    private Context context;
    private ListAdapter adapter;
    private View spinnerView;

    public PackageProvider(Context ctx, ListView view) {
        super(view);
        this.context = ctx;
    ...
    public ArrayList<Entity> getData(Integer page) {
        ...
        try {
            String response = client
                    .setUrl(SettingsHelper.getUrl(context, "get_package"))
                    .setMethod("GET")
                    .send();
            ...
            if (obj.opt("error") != null) {
                ...
                list = getEntityList(PackageEntity.class, items, page);
            }
        } catch (Exception e) {
